...
$DATABASE_USER = 'root';
$DATABASE_PASS = '';
$DATABASE_NAME = 'reklacy'; // Cambié el nombre de la base de datos a 'reklacy'
...
$stmt = $conexion->prepare('SELECT id_Empleado, Contraseña, email FROM accounts WHERE id = ?');

$stmt->bind_param('i', $_SESSION['id']);
$stmt->execute();
$stmt->bind_result($id_Empleado, $contrasena, $email);
$stmt->fetch();
$stmt->close();
?>
